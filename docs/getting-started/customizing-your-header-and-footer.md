...
- **Navigation** — select the Navigation block in your header to manage menu items, or go further with [Menu Designer](/docs/extensions/menu-designer/) for designed dropdowns, mega menus, and a custom mobile menu.
- **Sticky headers** — make your header stick to the top of the viewport with the Group block's Position setting, and see [Advanced Group Controls](/docs/extensions/advanced-group/) for the polished version: hide-on-scroll-down, mobile unsticking, and offset control.
...
For the deeper story on templates and template parts, read [How to Use WordPress Block Templates and Template Parts](https://olliewp.com/wordpress-block-template-part/).
