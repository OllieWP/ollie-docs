...
- **Icon Size** — in px, em, or rem. The default of `1.2em` scales naturally with your button's font size.
- **Icon Spacing** — the gap between icon and label (default `.5em`).
- **Show icon on left** — flip the icon from the right side (default) to the left.
