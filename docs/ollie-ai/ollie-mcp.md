...
- Prefer AI right inside the editor instead of an external agent? That's the other half of the story — see [Ollie AI](/docs/ollie-ai/ai-in-the-editor/) for the Writing Prompt and Design Prompt tools.
