...
Want to go deeper? See [how the Ollie theme is structured](/docs/support/block-theme-structure/), explore the [color palette](/docs/design/ollie-color-palette/) behind the design system — or, if you're building on your own foundation, learn about [using Ollie Pro with a custom theme](/docs/support/using-ollie-pro-with-a-custom-theme/).
